...
try:
    ...
    cursor.execute("""CREATE TABLE Regions(reg varchar(2) PRIMARY KEY, cheflieu varchar(10) not null, tncc varchar(10) not null, ncc varchar(40) not null, nccenr varchar(40) not null, libelle varchar(40) not null)""")
    ...
    cheflieu varchar(10) PRIMARY KEY, dep varchar(30), espH2015 float, espH2010 float, espF2015 float, espF2010 float, disSanteSup7 float, inondable2013 float, inondable2008 float)""")
    fileOpen = pd.ExcelFile('DD-indic-reg-dep_janv2018.xls')
